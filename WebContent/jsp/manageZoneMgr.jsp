	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>基础数据</li><li>结构</li><li>管养分区</li>
				</ol>
				<!-- end breadcrumb -->
		...
		<!-- END #MAIN PANEL -->
				...
				<form>
					...
					<div class="form-group" >
						...
						<div class="form-group">
							<label>管养分区编号</label><i class="text-danger">*</i>
							<input class="form-control" id="zone_no" value="" placeholder="管养分区编号" type="text">
						</div>
						<div class="form-group">
							<label>管养分区</label><i class="text-danger">*</i>
							<input class="form-control" id="zone_name" value="" placeholder="管养分区" type="text">
						</div>
					</fieldset>
				</form>
			</div>
