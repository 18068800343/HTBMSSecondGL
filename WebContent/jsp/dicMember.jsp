    ...
    <form>
        <fieldset>
            <div class="form-group">
                <label>构件类型编号</label>
                <input class="form-control" id="member_id" value="" placeholder="构件类型编号" type="text">
            </div>
            <div class="form-group">
                <label>构件类型名称</label>
                <input class="form-control" id="member_name" value="" placeholder="构件类型名称" type="text">
            </div>
        </fieldset>
    </form>
</div>
...
<script type="text/javascript">
    ...
    $('#dt_basic').delegate('.edit', 'click', function () {
        ...
        $('#member_id').prop('readonly', 'readonly');
        $('#dig').dialog({
            buttons: [
                {
                    ...
                    click: function () {
                        ...
                        if (info.member_id == "" || info.member_name == "") {
                            errMessage("不可为空");
                        } else {
                            $.ajax({
                                type: 'POST',
