                        ...
                        <div class="widget-body">
                            ...
                            <div class="widget-body-toolbar bg-color-white">
                                <div class="col-sm-6 col-md-6 text-align-left">
                                    ...
                                    <a href="dicComType.jsp" class="btn btn-default disabled">11评定</a>
                                    <a href="dicComType2.jsp" class="btn btn-default">04评定</a>
                                    <a href="dicComType3.jsp" class="btn btn-default">检查记录</a>
                            ...
                            <table class="table table-striped table-bordered table-hover pull-left" style="width: 16%"
                                   name="2011评定板、肋、箱形、双曲拱桥">
                                <thead>
                                <tr>
                                    <th colspan="2">11评定板、肋、箱形、双曲拱桥</th>
                                </tr>
                                <tr>
                                    <th style="width: 4%">编号</th>
                                    <th style="width: 12%">名称</th>
        ...
        <fieldset>
            ...
            <div class="form-group" id="sp">
                ...
                <select class="form-control input-sm" id="specification">
                    <option value="2011评定梁式桥">11评定梁式桥</option>
                    <option value="2011评定板拱桥,2011评定肋拱桥,2011评定箱形拱桥,2011评定双曲拱桥">11评定板、肋、箱形、双曲拱桥</option>
                    <option value="2011评定刚架拱桥,2011评定桁架拱桥">11评定刚、桁架拱桥</option>
                    <option value="2011评定钢混组合拱桥">11评定钢混组合拱桥</option>
                    <option value="2011评定悬索桥">11评定悬索桥</option>
                    <option value="2011评定斜拉桥">11评定斜拉桥</option>
                </select>
            </div>
        </fieldset>
    </form>
                            ...
                            $.ajax({
                                ...
                                success: function (json) {
                                    if (json.success == "fail") {
                                        ...
                                        //successMessage("保存成功");
                                        $("table[name=" + nn[info.specification] + "]").children('tbody').append(formate(info));
                                        $('#dig').dialog("close");
                                    }
                                }
                            });
