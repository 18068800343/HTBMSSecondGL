...
<html>
	...
	<body class="">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-colorbutton="false"
								...
								<div>
				                        ...
				                        <div class="widget-body-toolbar bg-color-white">
				                        	<div class="pull-left">
				                        	&nbsp&nbsp<a class="btn btn-primary">增加</a>
				                        	&nbsp&nbsp<a class="btn btn-primary">修改</a>
				                        	&nbsp&nbsp<a class="btn btn-primary">删除</a>
				                        	</div>
										</div>	
									<!-- widget content -->
									<div class="widget-body">
										<table class="table table-bordered table-striped text-align-center">
											<tr><th>桥梁</th><th>车辆荷载</th><th>温度</th><th>风速风向</th><th>主梁动位移</th><th>主梁动应变</th><th>主梁频率</th><th>索力</th><th>GPS</th><th>线形</th></tr>
											<tr><td>新沂河大桥</td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td><td></td><td></td><td></td><td></td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td><td></td><td></td></tr>
											<tr><td>永安河大桥</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
											<tr><td>苏北灌溉总渠大桥</td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
											<tr><td>灌河大桥</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td></tr>
											<tr><td>盐城东互通主线桥</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
											<tr><td>烈士河大桥</td><td></td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td><td></td><td></td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td></tr>
											<tr><td>秀珍河大桥</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
											<tr><td>新沭河大桥</td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>
											<tr><td>淮安大桥</td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a  onclick="watchData()"><u>查看</u></a>&nbsp&nbsp&nbsp<a  onclick="down()"><u>下载</u></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td>
											<td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td></tr>
											<tr><td>锡澄运河大桥</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><a class="glyphicon glyphicon-zoom-in" onclick="watchData()"></a>&nbsp&nbsp&nbsp<a class="glyphicon glyphicon-download" onclick="down()"></a></td></tr>
										</table>
									</div>
									<!-- end widget content -->
		...
		function watchData(){
			location.href="monitoringData3.jsp";
		}
		function down(){
