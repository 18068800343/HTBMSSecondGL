...
// 		    var result =/\.[^\.]+/.exec(file_name);
    ...
    //判断状态，是否存在正在进行项目 和 项目下是否存在当前涵洞结构
    var bridgeChk = {
        prj_id: undefined,
        prj_desc: undefined,
        chk_type: undefined,
    ...
    $('#dt_basic').delegate('.add', 'click', function () {
        ...
        window.location.href = encodeURI("checkCulvertSpan.jsp");
    });
            ...
            $.ajax({
                ...
                success: function (json) {
                    if (json.success == "fail") {
                        ...
                        $('.widget-body-toolbar a').eq(2).removeClass('btn-success disabled').addClass('btn-primary').text('完成涵洞检查');
                    }
                }
            });
    ...
    function releaseMember() {//项目参与人
    	if(info.prj_state==0){
            ...
            $('.widget-body-toolbar a').eq(0).removeClass('btn-warning disabled').addClass('btn-primary').text('照片');
            $('.widget-body-toolbar a').eq(1).removeClass('btn-warning disabled').addClass('btn-primary').text('选择跨');
            $('.widget-body-toolbar a').eq(2).removeClass('btn-warning disabled').addClass('btn-primary').text('完成涵洞检查');
