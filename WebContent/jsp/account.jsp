                                ...
                                <form class="form-horizontal" action="../ChangePassServlet" method="post">
                                    ...
                                    <fieldset class="demo-switcher-1">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="请输入当前密码" type="password"
                                                       name="oldpassword">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="请输入新密码" type="password"
                                                       name="password1">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" placeholder="请确认新密码" type="password"
                                                       name="password2">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a class="btn btn-primary" type="submit" onclick="changePass()">
                                                    确定
                                                </a> ${error1Info }
                                                ${successInfo}
                                                ${error2Info}
...
<script type="text/javascript">
    ...
    function changePass() {
        var pw =        <%=session.getAttribute("password") %>
        var oldpassword = $("input[name='oldpassword']").val();
