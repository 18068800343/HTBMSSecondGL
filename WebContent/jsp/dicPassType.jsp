                        ...
                        <div>
                            ...
                            <div class="widget-body-toolbar bg-color-white">
                                <div class="col-xs-12 text-align-left">
                                    ...
                                    <a href="dicPassType.jsp" class="btn btn-default disabled">通道类型</a>
                                    <a href="dicCulType.jsp" class="btn btn-default">涵洞类型</a>
            ...
            success: function (json) {
                if (json.success == "fail") {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#dt_basic').append('<tr><td>' + data[i].pass_type_id + '</td><td>' + data[i].pass_type_name + '</td></tr>')
                    }
                }
            }
        });
