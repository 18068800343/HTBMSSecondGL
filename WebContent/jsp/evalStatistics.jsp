	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>养护决策</li><li>统计分析</li><li>评定统计</li>
				</ol>
				<!-- end breadcrumb -->
											...
											<tr>
												...
												<tr>
													...
													<th style="width: 50px;">结构</th>
									 				<th style="width: 30px;">04分数</th>
									 				<th style="width: 20px;">11分数</th>
												</tr>
											</thead>
											<tbody>
...
/************************************************************结构*********************************************************************/
			...
			var table = $('#dt_basic').DataTable( {
				...
				"columns": [
						        ...
						        { "data": "zone" },
						        { "data": "struct" }, 
						        {"data": "eval04", "render": function(data, type, full){
						        	if(data==undefined){
						        		return "N/A";
						        	}else{
						        		return data;
						        ...
						        {"data": "eval11", "render": function(data, type, full){
						        	if(data==undefined){
						        		return "N/A";
						        	}else{
						        		return data;
