                                ...
                                <div class="widget-body-toolbar bg-color-white">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12 text-align-right">
                                            ...
                                            <a class="btn btn-primary disabled" onclick="redrict()">
                                                增加病害 </a> &nbsp; <a class="btn btn-primary disabled"
...
<script type="text/javascript">
    ...
    function buildCom(data) {
        ...
        $('#com')
            .append(
                "<select class='form-control input-sm select2'   onchange='comChange()'  style='width: 100%'></select>");
        var xx = $('#com select');
        for (var i = 0; i < data.length; i++) {
    ...
    function buildMem(data) {
        ...
        $('#mem')
            .append(
                "<select class='form-control input-sm select2'  style='width: 100%'><option value=''>---构件---</option></select>");
        var xx = $('#mem select');
        for (var i = 0; i < data.length; i++) {
                        ...
                        success: function (json) {
                            if (json.success == "fail") {
                                ...
                                if (selectDefect != undefined) {
                                    $('#defect_f').val(
                                            selectDefect.defect_f_name).trigger('change');
                            ...
                            buttons: [
                                {
                                    ...
                                    click: function () {
                                        ...
                                        info2.defect_photo = $(
                                            '#defect_photo')
                                            .val();
                                        info2.defect_photo_memo = $(
                                            '#defect_photo_memo')
                                            .val();
                                        info2.chk_defect_memo = $(
                                            '#chk_defect_memo')
                                            .val();
                                        var flag = true;
                                        var d1 = [];
                                        var d2 = [];
                                        $('#defect_loc_def').find('input,select').each(
                                            function () {
                                                var e = $(this).val();
                                                /* 	if(e==""||e==undefined){
                                                 flag = false;
                                        ...
                                        $('#defect_def').find('input,select').each(
                                            function () {
                                                var e = $(this)
                                                    .val();
                                                /*  	if(e==""||e==undefined){
                                        ...
                                        info2.defect_location_desc_val = JSON
                                            .stringify(d1);
                                        info2.defect_count_val = JSON
                                            .stringify(d2);
                                        ...
                                        info2.defect_location_desc = d.defect_loc_def
                                            .format(d1);
                                        info2.defect_count = d.defect_def
                                            .format(d2);
                                        ...
                                        $.ajax({
                                                ...
                                                success: function (json) {
                                                    if (json.success == "fail") {
                                                        ...
                                                        if (saveAndAdd) {
                                                            selectDefect = {};
                                                            selectDefect.defect_f_name = $(
                                                                '#defect_f')
                                                                .val();
                                                            selectDefect.defect_name = $(
                                                                '#defect')
                                                                .val();
    ...
    $('#dt_basic').delegate('.edit2', 'click', function () {
        ...
        if (defectData.defect_name_f != "自定义") {
            ...
            $("#defect_def_div").hide();
            $("#defect_attr_div").hide();
            $("#defect_div2").show();
            $("#defect2").val(de);
        }

        $('#chk_defect_memo').val(defectData.chk_defect_memo);
         $('#develop_state input[value="'
            + defectData.develop_state
            ...
            buttons: [
                {
                    ...
                    click: function () {
                        ...
                        if (defectData.defect_name_f == "自定义") {
                            info2.defect_name = $("#defect2").val();
                            info2.defect_name_f = "自定义";
                            info2.defect_location_desc_val = "";
                            info2.defect_count_val = "";
                            info2.defect_location_desc = "";
                            info2.defect_count = "";
                            info2.defect_attr = "";
                        } else {
                            info2.defect_attr = getAttrData();
                            info2.defect_name = d.defect_name;
        ...
        if (d != undefined) {
            ...
            for (var i = 0; i < d.defects.length; i++) {
                ...
                html = html + "<tr><td hidden='hidden'>"
                    ...
                    + "</td><td>" + d.defects[i].chk_defect_memo
                ...
                success: function (json) {
                    if (json.success == "fail") {
                        ...
                        $('.widget-body-toolbar a').eq(0).removeClass(
                            'disabled');
                        $('.widget-body-toolbar a').eq(1).removeClass(
                            'disabled');
                        span.chk_state = '0';
    ...
    function reSetPhotoName() {
        ...
        if (tableData.member_no == '其他') {
            ...
            name = tableData.member_no + nowDefect;
        }
    ...
    function redrict() {
        ...
        $.cookie("span", JSON.stringify(span));
        //console.info(info);
        window.location.href = encodeURI("defectTest.jsp");
    }
</script>
...
<div id="defectDialog" hidden="hidden" class="row">
    <form class="col-xs-12">
        <fieldset>
            <div class="form-group" id="defect_f_div">
                <label>病害类型</label> <select class="form-control input-sm"
                                            id="defect_f" onchange="buildDefect()">
            </select>
            </div>
            <div class="form-group" id="defect_div">
                <label>病害名称</label> <select class="form-control input-sm"
                                            id="defect" onchange="buildDefectDef()">
            </select>
            </div>
            <div class="form-group" id="defect_div2">
                <label>自定义病害名称</label>
                <input class="form-control input-sm" readonly="readonly" id="defect2" type="text">
            </div>
            ...
            <div class="form-group" id="defect_attr_div">
                <label>附加信息</label>
                ...
                <div id="develop_state" class="well"
                    ...
                    <div class="form-group">
                        <label class="radio radio-inline" style="vertical-align: bottom;">
                            <input type="radio" class="radiobox" value="2"
                                   name="develop_state"> <span>新增</span>
                        </label> <!-- <label class="radio radio-inline"
                                        style="vertical-align: bottom;"> <input type="radio"
                                                                                class="radiobox" value="0"
                                                                                name="develop_state"> <span>未发展</span>
                    </label> --> <label class="radio radio-inline"
                                    style="vertical-align: bottom;"> <input type="radio"
                                                                            class="radiobox" value="1"
