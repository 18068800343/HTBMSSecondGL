                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="pull-left col-xs-3">
                                                <select class="form-control input-sm pull-left"
                                                        onchange="memChange(this)" id="mem">
    ...
    <form>
        <fieldset>
            <div class="form-group">
                <label>构件类型</label>
                <select style="width:100%" class="form-control" id="member">

                </select>
            </div>
            <div class="form-group">
                <label>构件型号</label>
                <input class="form-control" id="member_type" value="" placeholder="构件型号" type="text">
            </div>
        </fieldset>
    </form>
</div>
            ...
            success: function (json) {
                if (json.success == "fail") {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        $('#mem').append("<option>" + data[i] + "</option>")
                    }
                }
            }
        });
