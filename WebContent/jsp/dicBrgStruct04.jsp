                                ...
                                <div class="widget-body-toolbar bg-color-white">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <a href="dicBrgStruct.jsp" class="btn btn-default pull-left">11评定</a>
                                            <a href="dicBrgStruct04.jsp"
                                               class="btn btn-default disabled pull-left">04评定</a>
...
<div id="dig" hidden="hidden">
    <form>
        <fieldset>
            ...
            <div class="form-group">
                <label>04评定</label>
                <select class="form-control input-sm" id="component7" data-name="2004评定">
                    <option></option>
                </select>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    ...
    var table = $('#std').DataTable({
        ...
        "columns": [
            ...
            {"data": "component7", "defaultContent": ""},//2004评定
    ...
    $('#std').delegate('.edit', 'click', function () {
        ...
        $('#component7').val(data.component7);
