	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>养护决策</li><li>统计分析</li><li>构件统计</li>
				</ol>
				<!-- end breadcrumb -->
										...
										<div class="panel panel-default" >
											...
											<div id="collapseOne" class="panel-collapse collapse in">
												...
												<div class="form-group col-xs-12 col-sm-6 col-lg-4">
													...
													<div class="form-group col-xs-12 col-sm-6 col-lg-4">
														<label>结构</label> 
														<select style="width:100%" class="form-control input-sm select2"  id="struct" >
														</select>
													</div>
													<div class="form-group col-xs-12 col-sm-6 col-lg-4">
														<label>方向</label> 
														<select style="width:100%" class="form-control input-sm select2"  id="direction" >
															<option value="%">全部</option>
															<option>上行</option>
															<option>下行</option>
															<option>无</option>
													...
													<div class="form-group col-xs-12 col-sm-6 col-lg-4">
														<label>跨号</label> 
														<input style="width:100%;height: 32px;" class="form-control input-sm"  placeholder="不输默认所有"  id="span">
													</div>
													<div class="form-group col-xs-12 col-sm-6 col-lg-4">
														<label>结构类型</label> 
														<select style="width:100%" class="form-control input-sm select2"  id="struct_type" >
														</select>
													</div>
													<div class="form-group col-xs-12 col-sm-6 col-lg-4">
														<label>分部结构</label>
									...
									<div class="col-xs-12">
										<table id="dt_basic" class="table table-striped table-bordered table-hover"  style="width: 100%">
											...
											<tr>
												...
												<tr>
													<th style="width: 50px;">路线</th>
													<th style="width: 50px;">管养单位</th>
													<th style="width: 50px;">下辖路段</th>
													<th style="width: 50px;">所属分区</th>
													<th style="width: 50px;">结构</th>
									 				<th style="width: 30px;">方向</th>
									 				<th style="width: 20px;">跨号</th>
									 				<th style="width: 60px;">结构类型</th>
													<th style="width: 50px;">分部结构</th>
													<th style="width: 50px;">部件类型</th>
													<th style="width: 50px;">构件类型</th>
													<th style="width: 70px;">构件</th>
													<th style="width: 50px;">构件型号</th>
												</tr>
											</thead>
											<tbody>
