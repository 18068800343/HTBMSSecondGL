    ...
    <div id="content">
        <section id="widget-grid">
            <div class="row">
                ...
                <article class="col-sm-10 col-md-8 col-lg-6">
                        ...
                        <div>
                            ...
                            <div class="widget-body-toolbar bg-color-white">
                                <div class="col-xs-12 text-align-left">
                                    ...
                                    <a href="dicBrgType.jsp" class="btn btn-default">桥梁类型</a>
                                    <a href="dicPassType.jsp" class="btn btn-default">通道类型</a>
                                    <a href="dicCulType.jsp" class="btn btn-default disabled">涵洞类型</a>
    ...
    <form>
        <fieldset>
            <div class="form-group">
                <label>桥型编号</label>
                <input class="form-control" id="brg_type_id" value="" placeholder="桥型编号" type="text">
            </div>
            <div class="form-group">
                <label>桥型名称</label>
                <input class="form-control" id="brg_type_name" value="" placeholder="桥型名称" type="text">
            </div>
        </fieldset>
    </form>
</div>
...
<script type="text/javascript">
    ...
    function initTable() {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                type: "initCulvertType"
            },
            error: function (msg) {
                errMessage("请求DicBrgTypeServlet失败");
            },
            success: function (json) {
                if (json.success == "fail") {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        $('#dt_basic').append('<tr><td>' + data[i].cul_type_id + '</td><td>' + data[i].cul_type_name + '</td></tr>')
                    }
                }
            }
        });
