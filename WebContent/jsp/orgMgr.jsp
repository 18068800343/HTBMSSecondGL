							...
							<div>
								...
								<div class="widget-body no-padding ">
									<div class="widget-body-toolbar bg-color-white text-align-left">
										...
										<div class="company col-sm-6 col-md-6 col-lg-6">
										<a id="add_company" onclick="addCompany()" class="btn btn-primary  btn-xs disabled" > <i class="fa fa-plus" id="addz"> 增加单位</i> </a> &nbsp;&nbsp; 
										<a onclick="editCompany()" class="btn btn-primary  btn-xs disabled"> <i class="fa fa-edit" id="delz"> 修改单位</i> </a> &nbsp;&nbsp; 
									...
									<div class="custom-scroll table-responsive" style="height:450px; overflow-y: scroll;">
										<div class="smart-form  col-sm-5 col-md-5 col-lg-5">
											<div class="widget-body-toolbar bg-color-white text-align-left">
												<div class="zone">
												<a  onclick="add_zone()" class="btn btn-primary  btn-xs disabled"> <!--  <i class="fa fa-plus" > -->增加分区<!--</i>--> </a> &nbsp; 
										...
										<div class=" col-sm-7 col-md-7 col-lg-7">
											...
											<li class="active"><a data-toggle="tab" href="#s1">角色</a></li>
											<li><a data-toggle="tab" href="#s2">人员</a></li>
											</ul>
										<div id="myTabContent1" class="tab-content">
										<div
											class="tab-pane fade active in padding-10 no-padding-bottom"
											id="s1" style=" height:400px;overflow-y:scroll;">
											<table id="table1" class="table table-bordered table-striped">
												<div class="col-sm-12 col-md-12 text-align-right">
													<div class="widget-body-toolbar bg-color-white">
														<a id="job_edit_b" onclick="job_edit()" type="submit"
															class="btn btn-primary  btn-xs disabled"  >修改</a>
													</div>
												</div>
												<tr>
													<th>编号</th>
										...
										<div class="tab-pane fade padding-10 no-padding-bottom" id="s2"
											...
											<table id="table2" class="table table-bordered table-striped">
												<div class="col-sm-12 col-md-12 text-align-right">
													<div class="widget-body-toolbar bg-color-white">
															<a onclick="add_usr()" type="submit"
															class="btn btn-primary btn-xs disabled" id="addUserButton" >增加</a>	
													</div>
												</div>
												<tr><th id="title_usr" colspan="4">沿江工程技术部</th></tr>
												<tr>
												<th>编号</th>
												<th>角色</th>
												<th>姓名</th>
										...
										<div class="row">
											<div class="col-sm-12 col-md-12 ">
												...
												<div class="col-xs-4 pull-right">
												 <label><h6>添加检测公司人员：</h6></label>
												 <button onclick="toAddCheckPeople()" id="addChkButton" disabled="true"
												 style="margin-top:0px;margin-bottom:3px;padding-top:0px"
												  class="btn btn-primary btn-xs ">添加</button>
												</div>
												<div id="switch_panel" class="col-xs-4 pull-right" hidden="hidden" style="width:185px;height:20px">
													<label><h6>建立日常项目： </h6></label><input id ="prj_build"  type="checkbox">
												</div>
												
												<!-- <a onclick="addUser()"
													class="btn btn-primary pull-right  disabled"> <i
													class="fa fa-link"></i> 关联 </a> -->
											</div>
					...
					success : function(json) {
						if(json.success=='success'){
							...
							for(var i = 0; i<jobdata.length; i++){
								...
								counts = checkCount(jobdata[i].org_usr_id);
								
								if(role_control=="duty"){
								}
								
								
							    if(counts!=null&&counts.length>0){
							    	table2.append("<tr><td>"+(i+1)+"</td><td>"+jobdata[i].job_name+"</td><td>"+jobdata[i].org_usr_name+"</td><td ><a id='"+jobdata[i].org_usr_id+"' onclick='edit_usr(this)'   class='btn btn-primary btn-xs "+control+"' >详细</a> "+
											"<a id='"+jobdata[i].org_usr_id+"d"+"' class='btn btn-primary btn-xs "+control+"'  onclick='del_usr(this)''>删除</a> <button id='"+jobdata[i].org_usr_id+"' onclick='addCount(this)' disabled='true'  class='btn btn-primary btn-xs "+control+"' >账号</button></td></tr>");
							    }else{
							    	table2.append("<tr><td>"+(i+1)+"</td><td>"+jobdata[i].job_name+"</td><td>"+jobdata[i].org_usr_name+"</td><td ><a id='"+jobdata[i].org_usr_id+"' onclick='edit_usr(this)'   class='btn btn-primary btn-xs "+control+"' >详细</a> "+
											"<a id='"+jobdata[i].org_usr_id+"d"+"' class='btn btn-primary btn-xs "+control+"'  onclick='del_usr(this)''>删除</a> <a id='"+jobdata[i].org_usr_id+"' onclick='addCount(this)'   class='btn btn-primary btn-xs "+control+"' >账号</a></td></tr>");
							    }
