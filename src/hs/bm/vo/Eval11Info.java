...
public class Eval11Info {
	...
	public String getCalcu_value() {
		return calcu_value;
	}
	public void setCalcu_value(String calcu_value) {
		this.calcu_value = calcu_value;
	}
