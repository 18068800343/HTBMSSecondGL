...
public class ChkSpanRecord {
	...
	/**上部结构*/
	private String span_top_struct;
	/**下部结构*/
	private String span_down_struct;
	/**备注*/
	...
	public void setSpan_top_struct(String span_top_struct){
		this.span_top_struct=span_top_struct;
	}

	public String getSpan_top_struct(){
		return span_top_struct;
	}

	public void setSpan_down_struct(String span_down_struct){
		this.span_down_struct=span_down_struct;
	}

	public String getSpan_down_struct(){
		return span_down_struct;
	}
