...
public class BrgMbrInfo {
	...
	public String toString() {
		return "BrgMbrInfo [r_id=" + r_id + ", s_id=" + s_id + ", member_type=" + member_type + ", member_no="
				+ member_no + ", member_desc=" + member_desc + ", member_model=" + member_model + "]";
	}
